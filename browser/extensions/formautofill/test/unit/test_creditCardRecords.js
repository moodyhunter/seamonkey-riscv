...
add_task(async function test_validate() {
  ...
  Assert.equal(creditCards[1]["cc-exp-month"], TEST_CREDIT_CARD_WITH_2_DIGITS_YEAR["cc-exp-month"]);
  Assert.equal(creditCards[1]["cc-exp-year"],
