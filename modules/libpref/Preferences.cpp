                              ...
                              void** aRetVal)
{
  ...
  if (aType.Equals(NS_GET_IID(nsIFile)) ||
      aType.Equals(NS_GET_IID(nsILocalFile))) {
...
pref_InitInitialObjects()
{
  ...
  // has MOZ_TELEMETRY _ON_BY_DEFAULT *or* we're on the beta channel, telemetry
  ...
  if (Preferences::GetDefaultType(kTelemetryPref) ==
    ...
    PREF_SetBoolPref(kTelemetryPref, false, false);
  }
