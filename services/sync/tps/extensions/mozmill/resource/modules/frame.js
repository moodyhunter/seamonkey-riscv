...
try {
  ChromeUtils.import('resource://jsbridge/modules/Events.jsm');
...
Collector.prototype.loadTestResources = function () {
  ...
  if (mozmill === undefined) {
    mozmill = {};
    ChromeUtils.import("resource://mozmill/driver/mozmill.js", mozmill);
  }
  if (mozelement === undefined) {
    mozelement = {};
    ChromeUtils.import("resource://mozmill/driver/mozelement.js", mozelement);
  }
}
...
function Runner() {
  ...
  var m = {}; ChromeUtils.import('resource://mozmill/driver/mozmill.js', m);
