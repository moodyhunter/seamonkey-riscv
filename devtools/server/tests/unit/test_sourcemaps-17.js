...
function test_source_map() {
  ...
  gThreadClient.addOneTimeListener("paused", function (event, packet) {
    gThreadClient.getFrames(0, 50, function ({ error, frames }) {
      ...
      Assert.equal(frames[0].where.source.url, "http://example.com/www/root/e.js");
      Assert.equal(frames[1].where.source.url, "http://example.com/www/root/c.js");
      Assert.equal(frames[2].where.source.url, "http://example.com/www/root/a.js");
