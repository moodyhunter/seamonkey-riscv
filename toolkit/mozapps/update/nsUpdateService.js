...
function Update(update) {
  ...
  this.backgroundInterval = Services.prefs.getIntPref(PREF_APP_UPDATE_BACKGROUNDINTERVAL, DOWNLOAD_BACKGROUND_INTERVAL);
    ...
    if (AppConstants.platform == "macosx" && update) {
      if (getElevationRequired()) {
        let installAttemptVersion =
          Services.prefs.getCharPref(PREF_APP_UPDATE_ELEVATE_VERSION, "");
