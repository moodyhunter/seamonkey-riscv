...
Blocklist.prototype = {
  ...
  async onXMLLoad(aEvent) {
    ...
    // However addons blocking status is refreshed.
    this._blocklistUpdated(oldAddonEntries);
...
#    </blocklist>
  ...
  _isBlocklistLoaded() {
    return this._addonEntries != null && this._gfxEntries != null;
  },
  ...
  _blocklistUpdated(oldAddonEntries) {
    var addonList = [];
