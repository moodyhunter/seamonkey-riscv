...
add_task(async function run_app_update_test() {
  info("Test: " + arguments.callee.name);
  ...
  Assert.equal(Services.prefs.getCharPref("general.skins.selectedSkin"), "test/1.0");
});
...
add_task(async function app_update_step_2() {
  ...
  Assert.equal(Services.prefs.getCharPref("general.skins.selectedSkin"), "classic/1.0");
