...
var PrintUtils = {
  ...
  print() {
    ...
    let ifReq = domWindow.QueryInterface(Ci.nsIInterfaceRequestor);
    let browser = ifReq.getInterface(Ci.nsIWebNavigation)
    ...
    let windowID = ifReq.getInterface(Ci.nsIDOMWindowUtils)
                        .outerWindowID;
