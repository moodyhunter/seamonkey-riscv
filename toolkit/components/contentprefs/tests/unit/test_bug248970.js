...
function run_test() {
    ...
    Assert.notEqual(cp, null, "Retrieving the content prefs service failed");
    ...
    try {
      ...
      Assert.equal(cp.getPref(uri1, pref_name), zoomA);
