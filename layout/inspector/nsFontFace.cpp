...
{
  *aFromFontGroup = bool(mMatchType &
...
{
  *aFromLanguagePrefs = bool(mMatchType &
                             gfxTextRange::MatchType::kPrefsFallback);
  return NS_OK;
}
...
{
  *aFromSystemFallback = bool(mMatchType &
                              gfxTextRange::MatchType::kSystemFallback);
  return NS_OK;
}
