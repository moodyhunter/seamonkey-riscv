...
void nsDocument::AddResizeObserver(ResizeObserver& aObserver) {
  if (!mResizeObserverController) {
...
void nsDocument::RemoveResizeObserver(ResizeObserver& aObserver) {
...
void nsDocument::ScheduleResizeObserversNotification() const {
  if (!mResizeObserverController) {
    return;
  }
