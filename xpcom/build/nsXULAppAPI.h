...
enum GeckoProcessType
{
  ...
  GeckoProcessType_Content = 2,

  GeckoProcessType_IPDLUnitTest = 3,

  GeckoProcessType_GMPlugin = 4, // Gecko Media Plugin

  GeckoProcessType_GPU = 5,      // GPU and compositor process
