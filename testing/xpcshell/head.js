...
// |Cr[resultName]| as the value of its 'result' property.
...
// Cr values, tries toString methods, and so on.
...
function do_load_manifest(path) {
  ...
  // Previous Assert.ok() is not a test check.
 ...
 *   Assert.equal(secondary, "expected value");
 * });
 *
 ...
 *
 * add_task({
 *   skip_if: () => !("@mozilla.org/telephony/volume-service;1" in Cc),
