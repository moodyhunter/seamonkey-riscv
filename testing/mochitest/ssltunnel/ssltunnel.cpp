...
int processConfigLine(char* configLine)
{
  ...
  if (!strcmp(keyword, "listen"))
  {
    ...
    else
    {
      ...
      server.host_tls11_table = PL_NewHashTable(0, PL_HashString, PL_CompareStrings,
                                                PL_CompareStrings, nullptr, nullptr);
      ...
      server.host_tls12_table = PL_NewHashTable(0, PL_HashString, PL_CompareStrings,
                                                PL_CompareStrings, nullptr, nullptr);
      ...
      server.host_tls13_table = PL_NewHashTable(0, PL_HashString, PL_CompareStrings,
                                                PL_CompareStrings, nullptr, nullptr);
...
int main(int argc, char** argv)
{
  ...
  for (auto & server : servers)
  {
    ...
    PL_HashTableEnumerateEntries(server.host_tls1_table, freeTLSHashItems, nullptr);
    PL_HashTableEnumerateEntries(server.host_tls11_table, freeTLSHashItems, nullptr);
    PL_HashTableEnumerateEntries(server.host_tls12_table, freeTLSHashItems, nullptr);
    PL_HashTableEnumerateEntries(server.host_tls13_table, freeTLSHashItems, nullptr);
