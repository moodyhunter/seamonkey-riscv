...
// expando if it exists. Specialized for NativeObject.
static void
                                             ...
                                             ValOperandId rhsId)
{
    ...
    writer.guardShapeForClass(objId, obj->as<ShapedObject>().shape());
                                             ...
                                             ValOperandId rhsId)
{
    ...
    if (CanAttachNativeSetSlot(cx_, JSOp(*pc_), expandoObj, id, isTemporarilyUnoptimizable_,
        ...
        GuardGroupProto(writer, nativeExpandoObj, expandoObjId);
